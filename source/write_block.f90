...
!Copyright (C)  2023 A.J. Koning
  subroutine write_endf(indent,library,author,year)
! 
! +---------------------------------------------------------------------
! | Author: Arjan Koning
! | Date  : May 20, 2023
! | Task  : Write output block for specific ENDF information
! +---------------------------------------------------------------------
!
! ****************** Declarations **************************************
!
...
!
  write(1,'("# endf:")')
  call write_char(indent,'library',trim(library))
  call write_char(indent,'author',author)
  call write_integer(indent,'year',year)
  return
  end
!Copyright (C)  2023 A.J. Koning
